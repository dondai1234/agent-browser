...
- **15 tools** load by default (no profile flag): navigate, see, find, read,
  click, fill, select, scroll, wait, screenshot, eval, tabs, upload, press_key,
  hover.
